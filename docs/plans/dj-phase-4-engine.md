...
10. **The paywall consumes `EntitlementStore.isPro`, never imports StoreKit** (§6.3): `PaywallView`
    ...
    you have now stays free" line, the proprietary-terms note, **no countdown / no strikethrough / no
