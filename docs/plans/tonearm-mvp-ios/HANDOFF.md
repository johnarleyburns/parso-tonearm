...
> It is no longer three subsystems — it is an **outcome**: pick a genre → build two deck playlists →
> mix with all five beginner transitions on club-standard controls → record 20 minutes → listen
