...
enum SyncMerge {
    ...
    static func winner<T>(local: T, localModified: Date?,
    ...
    static func remoteWins(localModified: Date?, remoteModified: Date?) -> Bool {
    ...
    static func mergePlayHistory(local: [PlayEvent], remote: [PlayEvent]) -> [PlayEvent] {
    ...
    static func applyDeletions(local: [String], deleted: Set<String>) -> [String] {
