...
public enum IANetworkError: Error, LocalizedError {
...
public actor IAClient {
    public static let shared = IAClient()
    ...
    public func data(from url: URL, attempt: Int = 0) async throws -> Data {
